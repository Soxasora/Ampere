 ...
 *	Controlla se il genere inserito esiste gia' grazie a controlloEsistenzaGenere
 *	e se non esiste, crea il genere con creaGenere e lo passa a inserireGenere
 ...
 *	Ottiene in input il record genere gia' compilato con creaGenere e gli assegna l'ultima posizione
 *	@output database modificato
 */
 ...
 *	@input numero intero identificativo, stringa nome del genere
...
/**
 *	TODO: passare a valori veri e non tutte stringhe
 *	@input numero intero identificativo brano, numero intero identificativo genere
 *	Scrive sul file "file_tipobrano", le informazioni date in input, separate con separatore pipe "|"
 *	@output FILE modificato
 */
 ...
 *	Se il genere e' presente, procede alla modifica dell'informazione scelta con modificaSingoloGenere
 *	@output database modificato
 */
 ...
 *	In base alla modalita' scelta e data in input da modificaGenere, chiede all'utente la nuova informazione
 ...
 *	Si avvale di ottieniPosDaID per controllare l'esistenza di esso attraverso l'identificativo
 *	Se il genere e' presente, procede alla cancellazione del genere con cancellaSingoloGenere
 *	@output database modificato
 */
