 ...
 *	Operazioni per la cancellazione del brano all'interno del void presente in memoria
 *	Scala il void di n=1 posizione indietro e lo spazio rimanente alla fine assume valore zero,
 *	effettivamente causando la cancellazione del brano all'interno del void presente in memoria.
